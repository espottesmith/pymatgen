...
from pymatgen.io.schrodinger.schrodinger_adapter import (file_to_schrodinger_structure,
...
class TestSchrodingerAdapter(unittest.TestCase):
    ...
    def test_maestro_file_to_molecule(self):
        molecules = maestro_file_to_molecule(os.path.join(schrodinger_dir, "ec.01.mae"))
